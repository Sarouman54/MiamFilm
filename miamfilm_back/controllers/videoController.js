...
exports.updateVideoById = async (req, res, next) => {
    videoService.updateVideoById(req.params.id, req.body.title, req.body.released, req.body.director, req.body.actors, req.body.synopsis, req.body.genre, req.body.type, req.body.runtime, req.body.poster, req.body.box_office)
